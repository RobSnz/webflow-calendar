(function (t, e) {
  ...
  function r(n, r, c) {
    ...
    function D(e) {
      he++,
        ...
        (ie = new Se[e](
          t(
            "<div class='fc-view fc-view-" + e + "' style='position:relative'/>"
          ).appendTo(ae),
          ee
        )),
        C(),
  ...
  function a(n, r) {
    function a() {
      ...
      var n = r.header;
      return n
        ? (h = t("<table class='fc-header' style='width:100%'/>").append(
            t("<tr/>").append(i("left")).append(i("center")).append(i("right"))
          ))
        : e;
    }
    function o() {
  ...
  function Z(e, n, r) {
    ...
    function u() {
      ...
      for (
        r += "<thead><tr>",
          ue &&
            (r += "<th class='fc-week-number " + n + "'>" + q(de) + "</th>"),
          t = 0;
        ne > t;
        t++
      )
  ...
  function K(n, r, a) {
    ...
    function p() {
      var t,
        ...
        l = "";
      for (
        l += "<tbody><tr><th class='fc-agenda-axis " + o + "'>&nbsp;</th>",
          n = "",
          e = 0;
        We > e;
        e++
